...
const LOCATIONS_DATA = [
  { id: 4, title: "Quảng Trường", time: "1 phút di chuyển", coords: [21.233396, 105.569000] as [number, number], icon: <Landmark size={22} /> },
  ...
  { id: 9, title: "Đảng Ủy Yên Lạc", time: "1 phút di chuyển", coords: [21.234612, 105.570036] as [number, number], icon: <Building2 size={22} /> },
