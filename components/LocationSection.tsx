...
const LOCATIONS_DATA = [
  ...
  { id: 4, title: "Quảng Trường", time: "2 phút di chuyển", coords: [21.233396, 105.569000] as [number, number], icon: <Landmark size={22} /> },
  { id: 6, title: "Sân Vận Động", time: "2 phút di chuyển", coords: [21.235000, 105.572000] as [number, number], icon: <Trophy size={22} /> },
  { id: 3, title: "Công An Huyện", time: "2 phút di chuyển", coords: [21.232049, 105.573540] as [number, number], icon: <ShieldCheck size={22} /> },
  ...
  { id: 9, title: "Đảng Ủy Yên Lạc", time: "2 phút di chuyển", coords: [21.234612, 105.570036] as [number, number], icon: <Building2 size={22} /> },
