import{j as e}from"./index-DD7uSXt0.js";import{g as h,r as o}from"./vendor-BPwQdSG7.js";import{g as c}from"./animations-CB87Sc6I.js";import{S as m}from"./ScrollTrigger-Cv03IO65.js";import{r as x}from"./maps-jBRwKcs2.js";import{B as g,G as p,j as v,k as f}from"./icons-BLzrB7lZ.js";var y=x();const l=h(y);c.registerPlugin(m);const i=({icon:r,title:n,time:s})=>e.jsxs("div",{className:`reveal-on-scroll flex items-center gap-4 p-5 rounded-2xl shadow-lg border-l-4 transition-all duration-300 hover:transform hover:translate-x-2
    ...
    dark:bg-navy-800 dark:text-white dark:border-gold-500 dark:hover:shadow-glow-gold`,children:[e.jsx("div",{className:`p-3 rounded-full transition-colors duration-300
      ...
      dark:bg-gold-500/20 dark:text-gold-400`,children:r}),e.jsxs("div",{children:[e.jsx("h4",{className:"font-bold text-sm md:text-base leading-tight",children:n}),e.jsx("p",{className:"text-xs mt-1 transition-colors text-gray-500 dark:text-gray-400",children:s})]})]}),T=()=>{const r=o.useRef(null),n=o.useRef(null),s=o.useRef(null),u=()=>{var t;(t=document.getElementById("contact"))==null||t.scrollIntoView({behavior:"smooth"}),window.dispatchEvent(new CustomEvent("nav-change",{detail:"contact"}))};return o.useEffect(()=>{if(!n.current||s.current)return;const t=l.map(n.current,{center:[21.1695,105.5768],zoom:16,scrollWheelZoom:!0,zoomControl:!1,attributionControl:!1});l.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{maxZoom:19}).addTo(t);const a=l.divIcon({className:"custom-pin",html:`<div style="
      ...
      ">
        <div style="
          ...
          border-radius: 50%;
        "></div>
      </div>`,iconSize:[30,30],iconAnchor:[15,30],popupAnchor:[0,-30]});return l.marker([21.1695,105.5768],{icon:a}).addTo(t).bindPopup('<div class="text-center"><b class="text-royal-600">Yên Lạc Dragon City</b><br/><span class="text-xs text-gray-600">Tâm điểm thịnh vượng</span></div>').openPopup(),s.current=t,setTimeout(()=>{t.invalidateSize()},500),setTimeout(()=>{t.invalidateSize()},2e3),()=>{t.remove(),s.current=null}},[]),o.useEffect(()=>{const t=c.context(()=>{r.current&&c.fromTo(r.current,{opacity:0,scale:.95,filter:"blur(10px)"},{opacity:1,scale:1,filter:"blur(0px)",duration:1.5,ease:"power3.out",scrollTrigger:{trigger:r.current,start:"top 70%"}})},r);return()=>t.revert()},[]),o.useEffect(()=>{const t=r.current;if(!t)return;const a=()=>{document.body.style.overflow="hidden"},d=()=>{document.body.style.overflow="auto"};return t.addEventListener("mouseenter",a),t.addEventListener("mouseleave",d),()=>{t.removeEventListener("mouseenter",a),t.removeEventListener("mouseleave",d),document.body.style.overflow="auto"}},[]),e.jsx("section",{className:"relative w-full overflow-hidden transition-colors duration-500 bg-white dark:bg-navy-900",children:e.jsx("div",{className:"container mx-auto",children:e.jsxs("div",{className:"flex flex-col lg:flex-row h-full",children:[e.jsxs("div",{className:"w-full lg:w-1/2 py-16 px-8 lg:pl-16 flex flex-col justify-center relative z-10",children:[e.jsxs("h2",{className:`text-4xl lg:text-5xl font-serif mb-6 leading-tight transition-colors duration-300 reveal-on-scroll
